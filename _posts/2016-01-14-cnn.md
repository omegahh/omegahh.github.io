...
![Example](/Pictures/CNN/convolution2.gif)
...
![Convolution_schematic](/Pictures/CNN/Convolution_schematic.gif)

> A good picture is more than 1000 words

那这个核可以用来干什么呢？下面举一些直观的例子来看一下卷积运算在图像处理中的应用。处理图像当然要拿出这位美女 **Lena** 了。

![Lena Origin](/Pictures/CNN/lena-origin.jpg)
...
![Convolution Lena](/Pictures/CNN/lena.jpg)
...
![Typical CNN](/Pictures/CNN/Typical_cnn.png)
...
![一个用于图像的CNN网络](/Pictures/CNN/convnet.jpg)
...
![Pooling](/Pictures/CNN/pooling.gif)
